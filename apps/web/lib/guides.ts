...
export const GUIDES: Guide[] = [
  {
    ...
    editorHref: "/editor",
    steps: [
      { title: "Add the screenshot", body: "Upload, paste, or drop your screenshot into the first shot. MockFrame keeps the source at its original quality.", image: "/guides/editor-canvas.png", imageAlt: "The MockFrame canvas with an empty iPhone frame and the add-screenshot button" },
      { title: "Choose the real device", body: "Open Device and select the phone, tablet, watch or laptop that matches your screenshot. Screen geometry is applied by the device template.", image: "/guides/device-picker.png", imageAlt: "The device picker open in MockFrame showing phones, tablets and laptops" },
      { title: "Style the composition", body: "Set the canvas ratio, backdrop, pattern and device transform. Keep contrast around the device so its silhouette remains clear.", image: "/guides/frame-backgrounds.png", imageAlt: "The Frame panel with gradient and pattern background options" },
      { title: "Export at the destination size", body: "Choose PNG, JPEG or WebP and the required scale. Use the platform ratio before export instead of cropping afterward.", image: "/guides/export-settings.png", imageAlt: "MockFrame export settings with format and scale options" },
    ],
  ...
  },
  {
    ...
    hero: "/guides/capture-dialog.png",
    ...
    steps: [
      { title: "Open website capture", body: "Start the URL workflow from the editor and enter a public HTTPS address.", image: "/guides/capture-dialog.png", imageAlt: "The website capture dialog in MockFrame with a URL field" },
      ...
      { title: "Place it in a frame", body: "Use a browser, laptop or desktop frame, then adjust screenshot fit without stretching the source.", image: "/guides/browser-frame-canvas.png", imageAlt: "A captured website inside a browser frame on the MockFrame canvas" },
    ],
  ...
  },
  {
    ...
    steps: [
      { title: "Create one shot per message", body: "Add every product screenshot as its own shot. Each shot keeps independent devices, transforms, text and media.", image: "/guides/shot-batch.png", imageAlt: "The shot batch panel managing multiple screenshots at once" },
      ...
      { title: "Reuse the theme", body: "Save the styling as a personal theme or export its JSON. Apply it to the remaining shots, then vary only what supports each message.", image: "/guides/right-panel.png", imageAlt: "The themes and export column in the MockFrame editor" },
  ...
  },
  {
    ...
    editorHref: "/editor",
    steps: [
      { title: "Finish the reference style", body: "Set the canvas, backdrop, typography, pattern and effects that should remain consistent.", image: "/guides/frame-backgrounds.png", imageAlt: "Background and pattern styling options in the Frame panel" },
      { title: "Save the theme", body: "Create a personal theme with a clear brand or campaign name.", image: "/guides/right-panel.png", imageAlt: "Saving a personal theme in the editor side panel" },
  ...
  },
  {
    ...
    hero: "/guides/browser-frame-canvas.png",
    ...
    steps: [
      ...
      { title: "Frame your product value", body: "Use MockFrame's Chrome Browser or iPhone 16 Pro frames to place the user inside your actual SaaS experience.", image: "/guides/browser-frame-canvas.png", imageAlt: "A SaaS dashboard presented in a Chrome browser frame" },
      { title: "Align brand aesthetics", body: "Apply cohesive color patterns and mesh gradients to blend the mockup with your landing page design.", image: "/guides/frame-backgrounds.png", imageAlt: "Mesh gradient and pattern styling controls" },
  ...
  },
  {
    ...
    hero: "/guides/chat-editor-hero.png",
    ...
    steps: [
      ...
      { title: "Configure replay timeline", body: "Arrange your chat bubble reveals or UI changes in the timeline. Use the MockFrame scrubber to fine-tune hold and fade timings.", image: "/guides/animate-panel.png", imageAlt: "The replay timeline scrubber under a chat scene" },
